...
const globSchemePrefix = schemeName + ":"
...
func TestNonExistent(t *testing.T) {
	fp := New()
	_, err := fp.Retrieve(context.Background(), globSchemePrefix+filepath.Join("testdata", "non-existent/*.yaml"), nil)
	assert.Error(t, err)
	_, err = fp.Retrieve(context.Background(), globSchemePrefix+absolutePath(t, filepath.Join("testdata", "non-existent/*.yaml")), nil)
	assert.Error(t, err)
	require.NoError(t, fp.Shutdown(context.Background()))
}
...
func TestInvalidYAML(t *testing.T) {
	fp := New()
	_, err := fp.Retrieve(context.Background(), globSchemePrefix+filepath.Join("testdata", "invalid-yaml.*"), nil)
	assert.Error(t, err)
	_, err = fp.Retrieve(context.Background(), globSchemePrefix+absolutePath(t, filepath.Join("testdata", "invalid-yaml.*")), nil)
	assert.Error(t, err)
	require.NoError(t, fp.Shutdown(context.Background()))
}
...
func TestInvalidPattern(t *testing.T) {
	fp := New()
	pattern := "\\"
	_, err := fp.Retrieve(context.Background(), globSchemePrefix+pattern, nil)
	assert.Error(t, err)
...
func TestRelativePath(t *testing.T) {
	fp := New()
	ret, err := fp.Retrieve(context.Background(), globSchemePrefix+filepath.Join("testdata", "multiple", "*.yaml"), nil)
...
func TestAbsolutePath(t *testing.T) {
	fp := New()
	ret, err := fp.Retrieve(context.Background(), globSchemePrefix+absolutePath(t, filepath.Join("testdata", "multiple", "*.yaml")), nil)
	require.NoError(t, err)
	retMap, err := ret.AsConf()
	assert.NoError(t, err)
	expectedMap := confmap.NewFromStringMap(map[string]interface{}{
...
func TestMergeOrder(t *testing.T) {
	fp := New()
	ret, err := fp.Retrieve(context.Background(), globSchemePrefix+absolutePath(t, filepath.Join("testdata", "ordered", "*.yaml")), nil)
	require.NoError(t, err)
	retMap, err := ret.AsConf()
	assert.NoError(t, err)
	expectedMap := confmap.NewFromStringMap(map[string]interface{}{
